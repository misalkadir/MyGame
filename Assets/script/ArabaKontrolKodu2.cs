...
public class ArabaKontrolKodu2 : MonoBehaviour
{
    ...
    {
        zHareketArti = Input.GetKey(KeyCode.UpArrow);
        zHareketEksi = Input.GetKey(KeyCode.DownArrow);
        xHareketArti = Input.GetKey(KeyCode.RightArrow);
        xHareketEksi = Input.GetKey(KeyCode.LeftArrow);
        ...
        // Fren Giriþi
        frenYapiliyor = Input.GetKey(KeyCode.P);
    }
